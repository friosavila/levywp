...
\hypersetup{
  pdftitle={Social Security and Gender Inequality},
...
\renewcommand{\thempfootnote}{\fnsymbol{mpfootnote}} 
    \centering
    \includegraphics[width=0.25\textwidth]{_extensions/levywp/logo.png}\\[0.25cm]
    \textbf{\large{\textcolor{Navy}{\fontspec{Arial}Working Paper No. ???}}}\\[0.3cm]

    \textcolor{lightgray}{\rule{0.8\textwidth}{0.5mm}}\\[0.5cm]

    \center{\textbf{Social Security and Gender Inequality\footnote{The
author is grateful to Collin Constantine and Ramesh Gampat for providing
valuable comments which have helped to improve the paper. Errors that
remain are the author's responsibility.}}} \\[0.5cm]
